...
import com.example.martialschool.enity.Coaches;
...
public class ServerConnectionTrainer {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    int id = jsonCoaches.getInt("coaches_id");
                    String name = jsonCoaches.getString("full_name");
                    String contactInformation = jsonCoaches.getString("contact_information");
    ...
    public static void updateCoachesOnServer(Coaches coaches) {
        try {
            ...
            String jsonData = "{ \"full_name\":\"" + coaches.getFull_name() + "\", \"contact_information\":\"" + coaches.getContact_information() + "\", \"login\":\"" + coaches.getLogin() + "\", \"information\":\"" + coaches.getInformation()+ "\"}";
